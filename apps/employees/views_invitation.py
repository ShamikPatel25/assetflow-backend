...
from apps.employees.serializers_invitation import (
...
class InvitationValidateView(APIView):
    ...
    @extend_schema(
        ...
        request=InvitationValidateSerializer, 
        responses={200: {"type": "object", "properties": {"email": {"type": "string"}}}}
    )
...
class InvitationSetupView(APIView):
    ...
    @extend_schema(
        ...
        request=InvitationSetupSerializer, 
...
class InvitationResendView(APIView):
    ...
    @extend_schema(
        ...
        request=InvitationResendSerializer, 
        responses={200: {"type": "object", "properties": {"message": {"type": "string"}}}}
    )
    def post(self, request, *args, **kwargs):
